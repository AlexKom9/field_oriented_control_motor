...
axes2 = axes('Parent',figure1,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes2,'on');
    hold(axes2,'all');
plot(t,w,'Parent',axes2,'LineWidth',2,'Color',[0 0 0]);
...
axes3 = axes('Parent',figure1,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes3,'on');
    hold(axes3,'all');
plot(t,ew,'Parent',axes3,'LineWidth',2,'Color',[0 0 0]);
...
axes4 = axes('Parent',figure1,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes4,'on');
    hold(axes4,'all');
plot(t,tet,'Parent',axes4,'LineWidth',2,'Color',[0 0 0]);
...
axes1 = axes('Parent',figure2,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes1,'on');
    hold(axes1,'all');
plot(t,idr,'Parent',axes1,'LineWidth',2,'Color',[0 0 0]);
...
axes2 = axes('Parent',figure2,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes2,'on');
    hold(axes2,'all');
plot(t,id,'Parent',axes2,'LineWidth',2,'Color',[0 0 0]);
...
axes3 = axes('Parent',figure2,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes3,'on');
    hold(axes3,'all');
plot(t,iqr,'Parent',axes3,'LineWidth',2,'Color',[0 0 0]);
...
axes1 = axes('Parent',figure3,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes1,'on');
    hold(axes1,'all');
plot(t,Ua,'Parent',axes1,'LineWidth',2,'Color',[0 0 0]);
...
axes3 = axes('Parent',figure3,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes3,'on');
    hold(axes3,'all');
plot(t,ub,'Parent',axes3,'LineWidth',2,'Color',[0 0 0]);
