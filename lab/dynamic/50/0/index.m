...
axes2 = axes('Parent',figure3,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes2,'on');
    hold(axes2,'all');
plot(group3.tms/1000,uq,'Parent',axes2,'LineWidth',2,'Color',[0 0 0]);
...
axes3 = axes('Parent',figure3,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes3,'on');
    hold(axes3,'all');
plot(group3.tms/1000,is1,'Parent',axes3,'LineWidth',2,'Color',[0 0 0]);
...
axes4 = axes('Parent',figure3,'XTickLabel',{'0','0.5','1','t, c'},...
    ...
    grid(axes4,'on');
    hold(axes4,'all');
plot(group3.tms/1000,Udc,'Parent',axes4,'LineWidth',2,'Color',[0 0 0]);
